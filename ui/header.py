...
class Header(ctk.CTkFrame):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        brand_frame.grid(row=0, column=0, sticky="w", padx=(14, 0), pady=10)
    ...
    def _reflow(self, event):
        """Keep every header action visible when the default window is narrow."""
        required = self._brand_frame.winfo_reqwidth() + self._actions_frame.winfo_reqwidth() + 50
        ...
        self._actions_frame.grid_configure(
            ...
            columnspan=2 if compact else 1, pady=(0, 10) if compact else 10,
        )
