...
class TacticalCommandCenter(ctk.CTk):
    ...
    def __init__(self):
        ...
        self._se_install_status = resolve_install(self.settings.space_engineers_install)
    ...
    def _apply_se_install_state(self) -> None:
        ...
        if status.valid and status.path is not None:
    ...
    def locate_space_engineers(self) -> None:
        ...
        self.settings_store.save(self.settings)
        self._se_install_status = resolve_install(str(root))
